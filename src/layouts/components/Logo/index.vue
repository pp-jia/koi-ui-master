<template>
  <div class="koi-logo" v-show="hidden">
    <img
      class="m-l-15px m-r-12px koi-logo-img rounded-full select-none"
      :src="logoUrl"
      alt="avatar"
      v-if="props.layout === 'vertical' || props.layout === 'mobile'"
    />
    <img
      class="m-l--3px m-r-12px koi-logo-img rounded-full select-none"
      :src="logoUrl"
      alt="avatar"
      v-if="props.layout === 'classic'"
    />
    <img
      class="m-l-6px m-r-12px koi-logo-img rounded-full select-none"
      :src="logoUrl"
      alt="avatar"
      v-if="props.layout === 'columns' || props.layout === 'optimum'"
    />
    <img
      class="m-l-17px m-r-12px koi-logo-img rounded-full select-none"
      :src="logoUrl"
      alt="avatar"
